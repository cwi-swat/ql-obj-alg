...
public class QLWithCheckAndModuloParser extends Parser {
	...
	private ql_obj_alg_diamond_extension.syntax.IAllAlgWithCheckAndModulo builder;
	public void setBuilder(ql_obj_alg_diamond_extension.syntax.IAllAlgWithCheckAndModulo builder) { this.builder = builder; }
	...
	public QLWithCheckAndModuloParser(TokenStream input) {
		super(input);
	...
	public static class FormContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(QLWithCheckAndModuloParser.ID, 0); }
	...
	public static class ExpContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(QLWithCheckAndModuloParser.ID, 0); }
		public TerminalNode BOOL() { return getToken(QLWithCheckAndModuloParser.BOOL, 0); }
		public TerminalNode INTEGER() { return getToken(QLWithCheckAndModuloParser.INTEGER, 0); }
		public TerminalNode STRING() { return getToken(QLWithCheckAndModuloParser.STRING, 0); }
		public TerminalNode PROPERTY() { return getToken(QLWithCheckAndModuloParser.PROPERTY, 0); }
	...
	private ExpContext exp(int _p) throws RecognitionException {
		...
		try {
			...
			case PROPERTY:
				{
				setState(36); ((ExpContext)_localctx).PROPERTY_0 = match(PROPERTY);
			...
			while ( _alt!=2 && _alt!=ATN.INVALID_ALT_NUMBER ) {
				if ( _alt==1 ) {
					...
					case 1:
						...
						_la = _input.LA(1);
						if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << 1) | (1L << 17) | (1L << 21))) != 0)) ) {
	...
	public static class StmtContext extends ParserRuleContext {
		...
		public TerminalNode ID() { return getToken(QLWithCheckAndModuloParser.ID, 0); }
		public TerminalNode TYPE() { return getToken(QLWithCheckAndModuloParser.TYPE, 0); }
		public TerminalNode STRING() { return getToken(QLWithCheckAndModuloParser.STRING, 0); }
		public StmtContext stmt(int i) {
			return getRuleContext(StmtContext.class,i);
		}
	...
	public final StmtContext stmt() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				{
				setState(80); ((StmtContext)_localctx).ID_0 = match(ID);
				setState(81); match(3);
				setState(82); ((StmtContext)_localctx).STRING_1 = match(STRING);
				setState(83); ((StmtContext)_localctx).TYPE_2 = match(TYPE);
			...
			case 3:
				...
				setState(87); ((StmtContext)_localctx).exp_0 = exp(0);
				...
				while (_la==12 || _la==ID) {
					{
					{
					setState(90); ((StmtContext)_localctx).stmt = stmt();
			...
			case 4:
				...
				while (_la==12 || _la==ID) {
					{
					{
					setState(104); ((StmtContext)_localctx).stmt = stmt();
					((StmtContext)_localctx).stmt_1.add(((StmtContext)_localctx).stmt);
					}
					}
					setState(109);
				...
				while (_la==12 || _la==ID) {
					{
					{
					setState(113); ((StmtContext)_localctx).stmt = stmt();
	...
	public static final String _serializedATN =
		...
		"\3\4\3\4\3\4\3\4\3\4\7\4^\n\4\f\4\16\4a\13\4\3\4\3\4\3\4\3\4\3\4\3\4\3"+
		"\4\3\4\3\4\7\4l\n\4\f\4\16\4o\13\4\3\4\3\4\3\4\3\4\7\4u\n\4\f\4\16\4x"+
		"\13\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\3\4\5\4\u0087\n"+
		"\4\3\4\2\3\4\5\2\4\6\2\5\5\2\3\3\23\23\27\27\4\2\30\30\32\32\6\2\4\4\7"+
		"\7\n\13\17\20\u0098\2\b\3\2\2\2\4(\3\2\2\2\6\u0086\3\2\2\2\b\t\7\31\2"+
		...
		"\30\b\3\1\2\30)\3\2\2\2\31\32\7\37\2\2\32)\b\3\1\2\33\34\7!\2\2\34)\b"+
